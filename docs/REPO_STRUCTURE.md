...
- `assets/dashboard.html.tmpl`, `assets/dashboard.css.tmpl`, `assets/dashboard.js.*.tmpl`: UI source of truth (`dashboard.js.tmpl`, `dashboard.js.bootstrap.tmpl`, `dashboard.js.chat.tmpl`, `dashboard.js.chat.events.tmpl`, and `dashboard.js.runtime.tmpl` are compatibility stubs; runtime JS is assembled from `dashboard.js.bootstrap.map.tmpl` + `dashboard.js.bootstrap.tickers.tmpl` + `dashboard.js.bootstrap.shared.tmpl` + `dashboard.js.chat.state.tmpl` + `dashboard.js.chat.events.core.tmpl` + `dashboard.js.chat.events.settings_map.tmpl` + `dashboard.js.chat.events.data_views.tmpl` + `dashboard.js.chat.render.tmpl` + `dashboard.js.runtime.views.tmpl` + `dashboard.js.runtime.poll.tmpl` + `dashboard.js.runtime.boot.tmpl`).
