...
3. Extend the remaining late-game conditionals, object routines, fuller thief/scoring logic, broader robot actor behavior, balloon timing/collapse details, and deeper death handling.
