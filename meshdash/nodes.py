...
from .helpers import extract_position_fields, to_int, to_jsonable
...
def get_local_node_num(
    iface: Any,
    *,
    to_jsonable_fn: Callable[..., Any] = to_jsonable,
    to_int_fn: Callable[[Any], Optional[int]] = to_int,
) -> Optional[int]:
...
def extract_position(
    ...
    *,
    extract_position_fields_fn: Callable[[Any], Optional[Tuple[float, float]]] = extract_position_fields,
