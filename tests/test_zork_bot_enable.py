...
def test_dashboard_tracker_can_toggle_zork_bot_runtime() -> None:
    ...
    assert enabled["adventure"]["enabled"] is True
    ...
    assert disabled["adventure"]["enabled"] is False
    tracker.on_receive(_direct_text_packet("zork", packet_id=112), iface)
    tracker.on_receive(_direct_text_packet("adventure", packet_id=113), iface)
    assert iface.sent == []
